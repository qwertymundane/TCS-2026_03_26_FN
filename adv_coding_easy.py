...
# Find subset of the array (solution subset can be of length 1 or the array length itself)
...
# INPUT: array [1<=len(array)<2^40] -- e.g (input): -1 2 3 4 -- read as `str` not `int`
# OUTPUT: the maximum product obtained from all possible subsets of the input array elements

# function max_sub_prod()

# function len_sub_prod()
